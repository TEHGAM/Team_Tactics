/*
	...
	Syntax:
	[<object>,<target>] call PO3_fnc_isDragging

	Returns: BOOLEAN
*/
private["_checkObject","_checkTarget","_return"];

_checkObject = (_this select 0) getVariable ["PO3_dragged",objNull];
_checkTarget = (_this select 1) getVariable ["PO3_dragged",objNull];
