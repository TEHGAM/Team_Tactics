...
if (isNil "KEGs_FuncsInited") then {
	...
	call compile preprocessFileLineNumbers ("scripts\keg_spectate\spect_funcs.sqf");
	spectate_events = compile preprocessFileLineNumbers ("scripts\keg_spectate\specate_events.sqf");
	KEGs_menucamslbchange = compile preprocessFileLineNumbers ("scripts\keg_spectate\menucamslbchange.sqf");
};
...
_dummy = PO3_reference_heliempty createVehicleLocal [0, 0, 0];
...
if (KEGs_no_butterfly_mode) exitWith {
	...
	0 spawn {sleep 0.01; [_player, _killer, "noWait"] execVM (PO3_path_modules+"keg_spectate\PO3_specate_Kegetys.sqf");};
};
...
deletevehicle _bird;
KEGs_SPECTATINGON = nil;
[_player, _killer, "noWait"] execVM execVM (PO3_path_modules+"keg_spectate\PO3_specate_Kegetys.sqf");